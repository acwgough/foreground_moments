#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Fri Aug 30 12:10:55 BST 2019      
date_start=`date +%s`
...
export OMP_NUM_THREADS=8
 /usr/local/shared/slurm/bin/srun -u -N 1 --mpi=pmi2 --mem-per-cpu=500 --ntasks-per-node=8 nice -n 10 /usr/bin/python3 MCMC.py
